...
const AboutContent = () => {
    return (    
        ...
        <div className="left">
            <h1>Who Am I ?</h1>
            <p>Hello there! I'm Shiva, a passionate frontend developer ready to make a mark in the world of web development. With a solid foundation in HTML, CSS, JavaScript and ReactJS, I have a strong desire to create captivating and user-friendly web experiences.
